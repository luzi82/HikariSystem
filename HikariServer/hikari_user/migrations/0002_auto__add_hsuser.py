...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HsUser'
        db.create_table(u'hikari_user_hsuser', (
        ...
        db.send_create_signal(u'hikari_user', ['HsUser'])


    def backwards(self, orm):
        # Deleting model 'HsUser'
        db.delete_table(u'hikari_user_hsuser')
